...
export function PracticeScreen({ onBack, appState }: { onBack: () => void; appState?: any; actions?: any }) {
  return (
    <Screen>
      ...
      <Card>
        ...
        <Text style={styles.body}>AI roleplay conversation practice with different social situations.</Text>
      </Card>
    </Screen>
  );
}
