...
export function ScenariosScreen({ onBack, appState }: { onBack: () => void; appState?: any; actions?: any }) {
  return (
    <Screen>
      ...
      <Card>
        ...
        <Text style={styles.body}>Practice contexts like ordering food, class, interviews, dating, and phone calls.</Text>
      </Card>
    </Screen>
  );
}
